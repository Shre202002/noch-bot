  ...
  //   // Load config
  //   fetch(baseUrl + '/api/knowledge/config?userId=' + userId + '&t=' + Date.now())
  //     .then(function(r) { return r.json(); })
  //     .then(function(d) {
  //       if (d.botName) hdrName.innerText = d.botName;
  //       if (d.botColor) {
  //         var c = d.botColor;
  //         bubbleBtn.style.background = c;
  //         document.getElementById('nochbot-header').style.background = c;
  //         sendBtn.style.background = c;
  //         var s = document.createElement('style');
  //         s.innerHTML = '.nb-msg-user{background:' + c + '!important}#nochbot-input:focus{border-color:' + c + '!important}';
  //         document.head.appendChild(s);
  //       }
  //       if (d.botIcon) hdrAvatar.innerHTML = '<img src="' + d.botIcon + '" />';
  //     })
  //     .catch(function() {});
