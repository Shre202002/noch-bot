...
export default function LoginPage() {
  ...
  const [error, setError] = useState<string | null>(searchParams.get('error') === 'google_failed' ? 'Google sign-in failed' : searchParams.get('error') === 'no_email' ? 'Could not get email from Google' : null);
        ...
        <div>
          ...
          <div className="mt-20 space-y-8">
            <h2 className="font-headline text-5xl font-bold tracking-tight text-[#FAFAFA] leading-tight">
              AI agents, <br />
              <span className="text-violet-500">without the friction.</span>
            </h2>
            <ul className="space-y-4">
              {[
                'Deploy intelligent agents in 60 seconds.',
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="space-y-2 text-center lg:text-left">
            <h1 className="font-headline text-3xl font-bold text-[#FAFAFA]">Sign in</h1>
            <p className="text-[#71717A]">Enter your credentials to access Nocta.</p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" size="sm" className="text-xs text-violet-500 hover:text-violet-400 transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <Input
          ...
          <p className="text-center text-sm text-[#71717A]">
            ...
            <Link href="/register" className="text-violet-500 hover:text-violet-400 transition-colors font-medium">
              Create an account
            </Link>
          </p>
        </div>
