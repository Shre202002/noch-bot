...
export const ResetPasswordForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!allRequirementsMet || !isCodeVerified) return;
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            {isVerifying && <p className="text-center text-sm text-zinc-500">Verifying code...</p>}
            {error && <p className="text-center text-sm text-red-500">{error}</p>}
            {isCodeVerified && (
              <motion.div
                className="flex items-center justify-center text-sm text-emerald-500"
            ...
            {isCodeVerified && (
              ...
              >
                <div className="space-y-4">
                  <h2 className="font-medium text-white">New password</h2>
