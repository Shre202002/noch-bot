      ...
      <DialogContent className="sm:max-w-md bg-black border-white/10 text-white">
        <div className="flex flex-col items-center gap-2">
          <div
            ...
            aria-hidden="true"
          >
            <img src="/noch-bot-logo-svg.svg" alt="logo" className="h-6 w-auto" />
          </div>
          <DialogHeader>
        ...
        <div className="mt-4 flex justify-center gap-4 text-[10px] uppercase tracking-widest font-bold text-zinc-500">
