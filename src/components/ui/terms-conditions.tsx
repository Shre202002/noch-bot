  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className="underline hover:no-underline cursor-pointer">Terms</button>
      </DialogTrigger>
          ...
          >
            <DialogDescription asChild>
              <div className="px-6 py-4">
                <div className="[&_strong]:text-foreground space-y-4 [&_strong]:font-semibold text-white/70">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      <p>
                        <strong className="text-white">User Account Responsibilities</strong>
                      </p>
                      <p>
                    ...
                    <div className="space-y-1">
                      <p>
                        <strong className="text-white">Content Usage and Restrictions</strong>
                      </p>
                      <p>
                    ...
                    <div className="space-y-1">
                      <p>
                        <strong className="text-white">User Conduct Guidelines</strong>
                      </p>
                    ...
                    <div className="space-y-1">
                      <p>
                        <strong className="text-white">Modifications to Terms</strong>
                      </p>
                      <p>
                    ...
                    <div className="space-y-1">
                      <p>
                        <strong className="text-white">Termination Clause</strong>
                      </p>
                      <p>
